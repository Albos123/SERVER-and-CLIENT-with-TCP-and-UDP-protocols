...
#perveq nese eshte zgjedhur "metoda" EXIT e cila e perfundon unazen e jashtme duke mos e lejuar qe komandat e dergimit dhe pranimit te mesazhit te ekzekutohen
    ...
    if (var == "EXIT"):
        break
    s.sendto(str.encode(var), (serverName, serverPort))     #dergimi i mesazhit i enkoduar ne bytes
    d = s.recvfrom(128)             #pranimi i mesazhit nga serveri i cili gjithashtu eshte i enkoduar ne bytes
    data = d[0]
